...
import SendMessage1WhenCustomerIsCreatedHandler from "../../customer/event/handler/send-message-1-when-customer-is-created.handler";
import SendMessage2WhenCustomerIsCreatedHandler from "../../customer/event/handler/send-message-2-when-customer-is-created.handler";
import SendMessageWhenAddressIsChangedHandler from "../../customer/event/handler/send-message-when-address-is-changed.event";
